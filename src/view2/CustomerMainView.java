...
public class CustomerMainView extends JFrame implements MouseListener, ItemListener {
	...
	void init() {
		...
		comboBox_4.setModel(new DefaultComboBoxModel(new String[] {"읍/면/동","사당동","삼성동"}));
	...
	public void itemStateChanged(ItemEvent e) {
		...
		if(e.getStateChange()==ItemEvent.SELECTED){
			...
			if(a.equals("서울")){
				comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"시/군/구","강남구","강동구","강북구","강서구","관악구","광진구","구로구",
						"금천구","노원구","도봉구","동대문구","동작구","마포구","서대문구","서초구","성동구","성북구","송파구","양천구","영등포구","용산구","은평구",
						"종로구","중구","중랑구"}));
			}
			if(a.equals("부산")){
				comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"시/군/구","강서구","금정구","기장군","남구","동구","동래구","부산진구",
						"북구","사상구","사하구","서구","수영구","연제구","영도구","중구","해운대구"}));
			}
			if(a.equals("대구")){
				comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"시/군/구","남구","달서구","달성군","동구","북구","서구","수성구","중구"}));
			}
			if(a.equals("인천")){
				comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"시/군/구","강화군","계양구","남구","남동구","동구","부평구","서구",
						"연수구","옹진군","중구"}));
			}
			if(a.equals("광주")){
				comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"시/군/구","광산구","남구","동구","북구","서구"}));
			}
			if(a.equals("대전")){
				comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"시/군/구","대덕구","동구","서구","유성구","중구"}));
			}
			if(a.equals("울산")){
				comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"시/군/구","남구","동구","북구","울주군","중구"}));
			}
			if(a.equals("세종")){
				comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"시/군/구"}));
			}
			if(a.equals("경기")){
				comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"시/군/구","가평군","고양시 덕양구","고양시 일산동구","고양시 일산서구",
			...
			if(a.equals("강원")){
				comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"시/군/구","강릉시","고성군","동해시","삼척시","속초시","양구군",
						"양양군","영월군","원주시","인제군","정선군","철원군","춘천시","태백시","평창군","홍천군","화천군","횡성군"}));
			}

			if(a.equals("충북")){
				comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"시/군/구","괴산군","단양군","보은군","영동군","옥천군","음성군",
			...
			if(a.equals("전남")){
				comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"시/군/구","강진군","고흥군","곡성군","광양시","구례군","나주시",
			...
			if(a.equals("경남")){
				comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"시/군/구","거제시","거창군","고성군","김해시","남해군","밀양시",
