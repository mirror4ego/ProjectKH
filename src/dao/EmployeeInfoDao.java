...
private ConnectionMaker connectionMaker;
	...
	public void add(EmployeeInfoDto employeeInfoDto) throws ClassNotFoundException, SQLException {
		...
		ps.setString(1, employeeInfoDto.getEmployeeInfoName());
	...
	public EmployeeInfoDto get(int employeeInfoNum) throws ClassNotFoundException, SQLException { // 
		...
		EmployeeInfoDto employeeInfoDto = new EmployeeInfoDto(); // 고객정보 클래스의 객체를 생성
		
		//customer.setCustomerNum(rs.getInt("customerNum"));
		employeeInfoDto.setEmployeeInfoName(rs.getString("employeeinfo_name"));
		...
		return employeeInfoDto; // 최종적으로 불러온 유저 정보에 관련한 객체를 리턴
	}
